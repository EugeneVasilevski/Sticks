...
public class MainActivity extends AppCompatActivity implements View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().hide(); // скрыть заголовок
    ...
    private void setDrawable() {
        switch (color) {
            case 1:
                relativeLayout.setBackgroundResource(R.drawable.blue_shape);
                break;
            case 2:
                relativeLayout.setBackgroundResource(R.drawable.purple_shape);
                break;
            default:
                break;
        }
    ...
    private int countScore() {
        ...
        if (logic.checkStrokeWithInitialization()) {
            ...
            if (logic.arrr[logic.x][logic.y] == 4) {
